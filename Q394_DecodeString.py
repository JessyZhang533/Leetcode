    ...
    def decodeString(self, s: str) -> str:
        ...
        for char in s:
            if char == "[":
                ...
                current_string = last_string + last_k * current_string  # !!!!! the order of addition MATTERS! Otherwise the blocks of substring will be in reverse order
            elif char.isdigit():
                k = k * 10 + int(char)  # handle integers >10
            else:
                current_string += char  # !!!
